...
public class FileTransferManager {
    ...
    public String startFileUpload(String clientId, String fileName, long fileSize, String fileType) {
        System.out.println("📤 Début upload - Client: " + clientId + ", Fichier: " + fileName + ", Taille: " + fileSize
                + " bytes");
        ...
        System.out.println(
                "✅ Session upload créée: " + sessionId + " pour " + fileName + " (" + formatFileSize(fileSize) + ")");
        return sessionId;
    }
    ...
    public boolean receiveFileChunk(String sessionId, int chunkIndex, byte[] data) {
        ...
        try {
            System.out.println(
                    "📦 Réception chunk " + chunkIndex + " pour session " + sessionId + " (" + data.length + " bytes)");
            ...
            if (session.isComplete()) {
                ...
                System.out.println("📊 Taille finale du fichier: " + file.length() + " bytes (attendu: "
                        + session.getFileSize() + ")");
                ...
                System.out.println("📊 Progrès: " + String.format("%.1f", progress) + "% ("
                        + session.getReceivedChunks() + "/" + session.getTotalChunks() + ")");
            }
