...
public class ControlExecutor {
            ...
            switch (type) {
                ...
                case "MOUSE_CLICK":
                    ...
                    if (isValidCoordinate(clickX, clickY)) {
                        ...
                        System.out
                                .println("🖱️ CLIC SIMPLE à: " + clickX + ", " + clickY + " (bouton: " + button + ")");
                    }
                    break;
                case "MOUSE_PRESS":
                ...
                case "KEY_PRESS":
                    ...
                    System.out.println(" Touche pressée: " + key + " (" + keyCode + ")" +
                            (ctrlKey ? " +Ctrl" : "") +
                            (shiftKey ? " +Shift" : "") +
                            (altKey ? " +Alt" : ""));
                    break;
                ...
                case "KEY_RELEASE":
                    ...
                    System.out.println(" Touche relâchée: " + releaseKeyCode);
                    break;
    ...
    private int convertToJavaKeyCode(int jsKeyCode) {
        switch (jsKeyCode) {
            ...
            default:
                System.out.println(" Code de touche non mappé: " + jsKeyCode);
                return jsKeyCode;
        }
    }
