...
public class AuthenticationManager {
    ...
    public boolean authenticatePassword(String clientId, String password) {
        ...
        if (expectedPassword != null && expectedPassword.equals(password)) {
            System.out.println(
                    "✅ Authentification réussie pour le client " + clientId + " avec le mot de passe: " + password);
            return true;
        }

        System.out.println("❌ Authentification échouée pour le client " + clientId + ". Mot de passe attendu: "
                + expectedPassword + ", reçu: " + password);
        return false;
    }
    ...
    public void addAuthenticatedClient(String clientId, String clientIP) {
        ...
        System.out.println(
                "🔐 Client authentifié: " + clientId + " (" + clientIP + ") avec mot de passe: " + usedPassword);
    }
    ...
    public void addAuthenticatedClient(String clientId, String clientIP, String displayName) {
        ...
        System.out.println("🔐 Client authentifié: " + displayName + " (" + clientId + " - " + clientIP
                + ") avec mot de passe: " + usedPassword);
    }
    ...
    public void removeClient(String clientId) {
        ...
        pendingConnections.entrySet().removeIf(entry -> entry.getValue().handler.getClientId().equals(clientId));
    }
    ...
    public void listActivePasswords() {
        ...
        if (clientPasswords.isEmpty()) {
            ...
            clientPasswords.forEach((clientId, password) -> {
                ...
                System.out.println("Client: " + displayName + " (" + clientId.substring(0, 8) + "...) - Mot de passe: "
                        + password + " - " + status);
            });
        }
        System.out.println();
    ...
    public boolean closeClientSession(String clientId, WebSocketClientHandler serverHandler) {
        ...
        if (client != null) {
            ...
            System.out.println(
                    "🔚 Session fermée par l'administrateur pour: " + client.displayName + " (" + clientId + ")");
            return true;
        }
        return false;
    }
