...
public class WebSocketServer {
    ...
    public WebSocketServer() {
        ...
        this.controlQueue.setServer(this);
    ...
    public void broadcastScreenDataFast(byte[] screenData, long frameId, List<WebSocketClientHandler> targetClients) {
        if (screenData == null || targetClients.isEmpty())
            return;
        ...
        switch (cmd) {
            ...
            case "chat":
                if (parts.length > 1) {
                    ...
                    main.java.chat.ChatMessage msg = new main.java.chat.ChatMessage("admin", "Admin", adminMessage,
                            "system");
    ...
    public void authenticateClient(String clientId, String clientIP, String displayName) {
        ...
        // Enregistrer le nom dans ControlQueue
    ...
    // Contrôle avec diffusion de liste
    ...
    // Suppression de client avec diffusion de liste
