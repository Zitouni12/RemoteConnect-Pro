...
const UserListComponent = ({ socketService, isAuthenticated }) => {
    ...
    const getAvatarColor = (userId, hasControl) => {
        ...
        return '#9e9e9e'; // Gris pour spectateurs
    };
